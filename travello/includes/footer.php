<?php
  echo "<footer class='footer'>
        <div
          ...
          data-image-src='images/footer_1.jpg'
          data-speed='0.8'
        ></div>
        <div class='container'>
          <div class='row'>
                  ...
                  >
                    ...
                    >
                      <div>
                        <input
                          type='text'
                          class='newsletter_input newsletter_input_name inpt'
                      ...
                      <div>
                        <input
                          type='email'
                          class='newsletter_input newsletter_input_email inpt'
